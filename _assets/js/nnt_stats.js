...
axios
     ...
     */
      ...
      function actorToObject(a) {
        let personShows = allShows.filter(function(d) {
        ...
        const personRecord = allPeople.find(function(d) {
          return d.title == a;
        });
     ...
     */
      ...
      // WHO'S BEEN IN THE MOST SHOWS
        ...
        y = d3
            .scaleLinear()
            .domain(
                d3.extent(showCounts2, function(d) {
                  return d.values.length;
                }),
            )
            .range([heightM, 0]);
