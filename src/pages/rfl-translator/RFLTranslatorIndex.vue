...
<div class="flex flex-col *:border-gray-500 space-y-4">
  <textarea name="input" id="input" cols="30" rows="10" v-model="input" placeholder="Copy the text from the RFL website here, and it should spit out a markdown table" />
